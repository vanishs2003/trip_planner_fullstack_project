...
DialogOverlay.displayName = "DialogOverlay"; // Explicitly define display name
...
DialogContent.displayName = "DialogContent"; // Explicitly define display name
...
DialogTitle.displayName = "DialogTitle"; // Explicitly define display name
...
DialogDescription.displayName = "DialogDescription"; // Explicitly define display name
